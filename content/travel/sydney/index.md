...
id: sydney
geography:
  continent: { id: oceania, label: Oceania }
  country_or_area: { id: australia, label: Australia }
  admin_path:
    - { kind: state, label: New South Wales }
    - { kind: metropolitan-region, label: Greater Sydney }
  place_kind: { id: city, label: City }
  card_badge: State capital
coordinates: { lat: -33.8678, lon: 151.2100, zoom: 9 }
trips:
  - id: sydney-2024-december
    status: visited
    when:
      start: "2024-12-02"
      end: "2024-12-12"
      display: "2–12 December 2024"
      precision: day
    note: I spent 3–6 December at the University of Sydney for the satellite event and summer school “Recent Trends in Algorithms.” From 9–11 December, I attended the 35th International Symposium on Algorithms and Computation (ISAAC 2024), where our paper “Revisit the Scheduling Problem with Calibrations” was accepted and I presented it on 9 December. Between the two events, I explored the city and attended two performances.
    photos:
      - file: university-of-sydney-quadrangle-2024-12-02.jpeg
        alt: The University of Sydney Quadrangle beneath a bright blue sky
        when:
          start: "2024-12-02"
          display: "2 December 2024"
...
---
A research trip combining a summer school and ISAAC 2024 with time to explore Sydney’s university, coast, theatres, and harbour.
